...
//    AngularTeoria.js
//    An Angular.js wrapper to use Teoria.js as an Angular module
//    AngularTeoria.js may be freely distributed under the MIT License.
//    Copyright Fabricio Quagliariello (fmquaglia)

//    Teoria.js:
//    http://saebekassebil.github.com/teoria
//    Copyright Jakob Miland (saebekassebil)

(function(angular, teoria) {
  'use strict';
  var self = teoria || window.teoria || (function teoriaScope() {
      'use strict';
      ...
      teoria.note.fromString = function(name, dur) {
        var scientific = /^([a-h])(x|#|bb|b?)(-?\d*)/i, helmholtz = /^([a-h])(x|#|bb|b?)([,\']*)$/i, parser, noteName, octave, accidental, note, lower;
      ...
      teoria.interval.toCoord = function(simple) {
        var pattern = /^(AA|A|P|M|m|d|dd)(-?\d+)$/, parser, number, coord, quality, lower, octaves, base, type, alt, down;
      ...
      TeoriaInterval.prototype = {
        ...
        value: function() {
          var without = sub(this.coord,
            mul(sharp, Math.floor((this.coord[1] - 2) / 7) + 1)), i, val;
